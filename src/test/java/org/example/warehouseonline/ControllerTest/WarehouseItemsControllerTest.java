...
//
//    @Test
//    public void getAllItems_WithFilterParams_ShouldReturnFilteredItemsWithPagination() throws Exception {
//        // Мокация данных
//        String warehouse = "Warehouse A";
//        String category = "Electronics";
//        String filter = "Item 1";
//
//        WareHouseItems item1 = new WareHouseItems();
//        item1.setName("Item 1");
//
//        // Создаём страницу с элементами
//        Page<WareHouseItems> page = new PageImpl<>(List.of(item1)); // корректный мокационный Page
//        when(warehouseItemsService.getFilteredItems(0, 10, warehouse, category, filter))
//                .thenReturn(ResponseEntity.ok(page)); // мокация возвращаемого объекта
//
//        // Выполняем запрос
...
//                .andExpect(jsonPath("$.content[0].name").value("Item 1")) // Проверяем содержимое
//                .andExpect(jsonPath("$.content.length()").value(1)); // Убеждаемся, что длина контента равна 1
//    }
//
//
//
//    @Test
//    public void getAllItems_WithoutParams_ShouldReturnAllItemsWithPagination() throws Exception {
//        WareHouseItems item1 = new WareHouseItems();
//        item1.setName("Item 1");
//
//        WareHouseItems item2 = new WareHouseItems();
//        item2.setName("Item 2");
//
//        Page<WareHouseItems> page = new PageImpl<>(List.of(item1, item2));
//        ResponseEntity<Page<WareHouseItems>> responseEntity = ResponseEntity.ok(page);
//
//        when(warehouseItemsService.getFilteredItems(0, 10, null, null, null)).thenReturn(responseEntity);
//
//        mockMvc.perform(get("/api/warehouse/items")
//                        .header("Authorization", jwtToken)
//                        .param("page", "0")
...
//                .andExpect(jsonPath("$.content.length()").value(2)); // Проверяем длину контента
//    }
//
//
//    @Test
